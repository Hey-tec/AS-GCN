...
class Links(object):
    ...
    def assign_triplet_rel(self):
        ...
        # print 'triplet_rel:' + str(self.triplet_rel)
    ...
    def compute_prev_links(self):
        ...
        # print 'prev_links:' + str(self.prev_links)
    ...
    def compute_prev_p2p_p2c(self):
        ...
        for link in self.prob:
            p2p, p2c, c2p = map(lambda x: np.float64(x), self.prob[link])
            if p2p > c2p or p2c > c2p:
                self.prev_p2p_p2c[link[1]].add(link)
        # print 'prev_p2p_p2c:' + str(self.prev_p2p_p2c)
    ...
    def assign_nonpath(self):
        ...
        # print 'nonpath:' + str(self.nonpath)
    ...
    def assign_distance_to_tier1(self):
        ...
        # print 'distance_to_tier1:' + str(self.distance_to_tier1)
    ...
    def assign_colocated_ixp(self, peeringdb_file):
        ...
        # print 'colocated_ixp:' + str(self.colocated_ixp)
    ...
    def assign_colocated_facility(self, peeringdb_file):
        ...
        # print 'colocated_facility:' + str(self.colocated_facility)
