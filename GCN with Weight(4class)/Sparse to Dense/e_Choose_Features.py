...
choose_file = open("./Source Data/file_2017_04_01/AS_Features.txt", "w")

with open("./Source Data/file_2017_04_01/AS_8_Features.txt") as f:
    for line in f:
        ASN, degree, transit_degree, distance_to_tier1, vp_out, hierarchy, \
        distance_to_vp_min, distance_to_vp_max, distance_to_vp_avg = line.strip().split()

        choose_features = [degree, transit_degree, distance_to_tier1, vp_out, hierarchy, distance_to_vp_min, distance_to_vp_max, distance_to_vp_avg]
